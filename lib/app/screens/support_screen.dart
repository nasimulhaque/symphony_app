...
class CheckSupportScreen extends StatelessWidget {
      ...
      child: Scaffold(
        ...
        body: GridView.extent(
          ...
          children: [
            ...
            item(context, title: "Service Center", asset:  "assets/vectors/service-center${themeIsLight ? "" : "-dark"}.svg"),
            item(context, title: "LSO Query", asset:  "assets/vectors/lso${themeIsLight ? "" : "-dark"}.svg"),
            item(context, title: "Feedback", asset:  "assets/vectors/feedback${themeIsLight ? "" : "-dark"}.svg"),
            item(context, title: "Specification", asset:  "assets/vectors/specification${themeIsLight ? "" : "-dark"}.svg"),
  ...
  Widget item(BuildContext context, {required String asset, required String title}) {
    return Container(
      height: 100,
